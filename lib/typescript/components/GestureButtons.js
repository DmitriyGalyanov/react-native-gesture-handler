...
class InnerBaseButton extends React.Component {
    ...
    render() {
        ...
        return (<RawButton ref={this.props.innerRef} rippleColor={processColor(rippleColor)} {...rest} onGestureEvent={this.onGestureEvent} onHandlerStateChange={this.onHandlerStateChange}/>);
    }
}
...
class InnerBorderlessButton extends React.Component {
    ...
    render() {
        ...
        return (<AnimatedBaseButton {...rest} 
        ...
        innerRef={innerRef} onActiveStateChange={this.onActiveStateChange} style={[style, Platform.OS === 'ios' && { opacity: this.opacity }]}>
        {children}
      </AnimatedBaseButton>);
    }
}
